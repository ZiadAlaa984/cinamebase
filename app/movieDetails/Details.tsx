import { MovieDetails } from "@/interface/Types";
      ...
      <div className="w-full grid grid-cols-3  h-auto gap-6 pt-12 lg:gap-48 ">
        <div className="flex  col-span-3 lg:col-span-2  gap-2 justify-start w-full order-2   relative items-start flex-col">
            ...
            {posterSrc ? (
              <>
                <Image
                  src={posterSrc}
                  alt={Movie.title}
                  className="w-fit max-h-[150px] object-contain"
                  width={500}
                  height={100}
                />
              </>
          ...
          <div className="flex gap-2 items-center lg:items-start flex-col w-full">
            <div className=" w-full mBlur flex justify-center items-center lg:block borderGlass rounded-3xl ">
              <p className="bg-transparent capitalize backdrop-blur-3xl   max-w-2xl border border-white/30 px-5 py-2 lg:text-sm mBlur borderGlass rounded-3xl inline-block text-white font-medium">
